...
const About = () => {
  const handleDownloadCV = () => {
    window.open("/cv/Nethmi Nilakshi  CV.pdf", "_blank");

    const newWindow = window.open("/cv/Nethmi Nilakshi  CV.pdf", "_blank");
    setTimeout(() => {
      const link = document.createElement("a");
      link.href = "/cv/Nethmi Nilakshi  CV.pdf";
      link.download = "Nethmi Nilakshi  CV.pdf";
      link.click();
    }, 1000);
  };
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-lg text-gray-300 leading-relaxed">
              Motivated and results-driven Full Stack Developer with hands-on
              industry experience designing and developing web applications
              using cutting-edge technologies. Expertise spans across frontend
              and backend development — from Next.js, Vue.js, and React on the
              frontend to Laravel, NestJS, and Node.js on the backend, backed by
              strong database skills in MySQL and MongoDB.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              A Graduate Diploma in Software Engineering (GDSE) graduate from
              IJSE, currently advancing my qualifications through a BSc (Hons)
              in Software Engineering at ICBT. Passionate about creating
              innovative, scalable software solutions and eager to contribute
              technical expertise to challenging real-world projects.
            </p>
