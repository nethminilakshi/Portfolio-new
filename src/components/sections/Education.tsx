...
const Education = () => {
  const education = [
    {
      degree: "Bachelor of Science in Software Engineering (BSc)",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-8">
          {education.map((edu, index) => (
            <div
              key={index}
              className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-6 hover:border-cyan-400/50 transition-all duration-300"
            >
